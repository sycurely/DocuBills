...
<div class="dash-shell">
  ...
  <section class="dash-card">
    <div class="dash-card-head">
      ...
      <a href="{{ route('invoices.index') }}" class="btn btn-outline">View All</a>
    </div>
    <div class="table-container">
...
<script>
  ...
  function loadDashboard(period = 'daily') {
    fetch(`{{ route('api.dashboard.data') }}?period=${period}&_=${Date.now()}`)
    ...
    fetch(`{{ route('api.dashboard.data') }}?period=all&_=${Date.now()}`)
      .then(response => response.json())
      .then(summary => {
  ...
  function loadSummary() {
    fetch('{{ route("api.dashboard.summary") }}')
      .then(response => response.json())
      .then(summary => {
  ...
  function loadTopClients() {
    fetch('{{ route("api.dashboard.data") }}?paid_clients=true')
      .then(response => response.json())
      .then(data => {
    ...
    fetch('{{ route("api.dashboard.data") }}?unpaid_clients=true')
      .then(response => response.json())
      .then(data => {
