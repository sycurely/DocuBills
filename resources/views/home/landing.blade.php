...
@section('content')
    ...
    <header id="header">
        <div class="container">
            <nav class="navbar">
                <a href="#" class="logo">
                    <img src="{{ asset('homepage/images/docubills-logo.png') }}" alt="Docubills - Your paperwork, made simple">
                </a>
                ...
                <div class="nav-actions">
                        ...
                        <div class="landing-user-profile" id="landingUserProfile">
                            <div class="landing-user-avatar">
                                @if($user->avatar)
                                    ...
                                    @endphp
                                    <img src="{{ $avatarUrl }}?v={{ time() }}" alt="Avatar" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-secondary" id="signInBtn">Sign In</a>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-image">
                    <img id="heroImage" src="{{ asset('homepage/images/hero.png') }}" alt="Invoice Dashboard Preview" class="dashboard-preview">
                          ...
                          <div class="main-content">
                            ...
                            <div class="invoice-box">
                                ...
                                <div class="inv-row-top">
                                  <div class="inv-logo">
                                    <div class="demo-logo-box"><img src="{{ asset('homepage/images/docubills-logo.png') }}" alt="Docubills"></div>
                                  </div>
...
<div id="demoSignupModal" class="demo-signup-modal" style="display: none;">
  ...
  <div class="demo-signup-modal-content">
    ...
    <div class="demo-signup-modal-actions">
      <a href="{{ route('login') }}" class="demo-signup-btn-primary">
        Sign up free <i class="fas fa-arrow-right"></i>
      </a>
      <a href="{{ route('login') }}" class="demo-signup-btn-secondary">
