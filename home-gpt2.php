...
.miniApp .option-row input{
  ...
  margin: 0;
   ...
   #miniDemo3 .company-logo-fallback{
    ...
    /* -----------------------------------------
       Premium CTA + small UX polish (landing only)
    ----------------------------------------- */
    ...
    .ring-glow{
      box-shadow:
        0 0 0 1px rgba(var(--cyan), .22),
        0 18px 45px rgba(var(--violet), .22);
      transform: translateZ(0);
    }
    .ring-glow:hover{
      box-shadow:
        0 0 0 1px rgba(var(--cyan), .35),
        0 22px 60px rgba(var(--violet), .28);
      transform: translateY(-1px);
    }
        ...
        <div class="grid lg:grid-cols-2 gap-10 items-center">
          <!-- Left -->
            ...
            <p class="mt-5 text-slate-200 text-lg leading-relaxed">
              Upload Excel or paste a Google Sheet URL. Pick any column as your <span class="text-white font-semibold">Price</span>.
              Then deselect columns/rows you don’t want printed — and generate a clean PDF invoice with optional Stripe, recurring, and reminders.
            </p>
