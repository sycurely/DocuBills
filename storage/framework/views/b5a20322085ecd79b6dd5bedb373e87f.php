...
<?php $__env->startSection('title', 'Settings - Reminder Rules'); ?>
...
<form method="POST" action="<?php echo e(route('settings.reminders.update')); ?>" id="reminderRulesForm">
  <?php echo csrf_field(); ?>
  <div class="rem-shell">
    <section class="rem-card" aria-label="Reminder Rules">
      ...
      <div id="rulesList" class="rem-rules-list" data-rules-list>
        <?php $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <article class="rem-rule-card rem-rule-row <?php echo e($idx === 0 ? 'is-expanded' : ''); ?>" data-rule-card data-rule-index="<?php echo e($idx); ?>">
            <div class="rem-rule-header">
              <button
                ...
                aria-controls="rule-panel-<?php echo e($idx); ?>"
              >
                <span class="rem-rule-heading">
                  <span class="material-icons-outlined">schedule</span>
                  <span data-role="rule-number">Rule #<?php echo e($idx + 1); ?></span>
                  <span data-role="summary-name"><?php echo e(trim((string) ($rule['name'] ?? '')) !== '' ? $rule['name'] : 'Untitled Rule'); ?></span>
                </span>
                <span class="rem-chip-row">
                  <span class="rem-chip <?php echo e(!empty($rule['enabled']) ? 'is-enabled' : 'is-disabled'); ?>" data-role="summary-enabled">
                    <span class="material-icons-outlined">notifications</span>
                    <?php echo e(!empty($rule['enabled']) ? 'Enabled' : 'Disabled'); ?>

                  </span>
                  <span class="rem-chip" data-role="summary-direction">
                    <span class="material-icons-outlined">event</span>
                    <?php echo e(ucfirst((string) $rule['direction'])); ?>

                  </span>
                  <span class="rem-chip" data-role="summary-days">
                    <span class="material-icons-outlined">today</span>
                    <?php echo e((int) $rule['days']); ?> day(s)
                  </span>
                </span>
              </button>
              ...
              <div class="rem-rule-header-actions">
                <div class="rem-header-toggle-wrap">
                  <span>Enabled</span>
                  <input type="hidden" data-field="enabled" name="rules[<?php echo e($idx); ?>][enabled]" value="<?php echo e(!empty($rule['enabled']) ? '1' : '0'); ?>">
                  <button
                    type="button"
                    class="rem-switch-btn"
                    data-role="enabled-toggle"
                    role="switch"
                    aria-checked="<?php echo e(!empty($rule['enabled']) ? 'true' : 'false'); ?>"
                    aria-label="Toggle rule enabled"
                  >
                    <span class="material-icons-outlined"><?php echo e(!empty($rule['enabled']) ? 'toggle_on' : 'toggle_off'); ?></span>
                    <span data-role="enabled-toggle-label"><?php echo e(!empty($rule['enabled']) ? 'On' : 'Off'); ?></span>
                  </button>
                </div>
                ...
                <button
                  ...
                  class="rem-icon-btn"
                  data-role="chevron"
                  aria-label="<?php echo e($idx === 0 ? 'Collapse rule details' : 'Expand rule details'); ?>"
                  aria-expanded="<?php echo e($idx === 0 ? 'true' : 'false'); ?>"
                  aria-controls="rule-panel-<?php echo e($idx); ?>"
                >
                  <span class="material-icons-outlined"><?php echo e($idx === 0 ? 'expand_less' : 'expand_more'); ?></span>
                </button>
              </div>
            </div>

            <div id="rule-panel-<?php echo e($idx); ?>" class="rem-rule-body" data-role="panel" <?php if($idx !== 0): ?> hidden <?php endif; ?>>
              <input type="hidden" data-field="id" name="rules[<?php echo e($idx); ?>][id]" value="<?php echo e($rule['id']); ?>">
              <div class="rem-grid">
                <div class="field">
                  <label><span class="material-icons-outlined">label</span> Name</label>
                  <input type="text" data-field="name" name="rules[<?php echo e($idx); ?>][name]" value="<?php echo e($rule['name']); ?>" required>
                </div>
                <div class="field">
                  <label><span class="material-icons-outlined">event</span> Direction</label>
                  <select data-field="direction" name="rules[<?php echo e($idx); ?>][direction]" required>
                    <option value="before" <?php echo e($rule['direction'] === 'before' ? 'selected' : ''); ?>>Before</option>
                    <option value="on" <?php echo e($rule['direction'] === 'on' ? 'selected' : ''); ?>>On</option>
                    <option value="after" <?php echo e($rule['direction'] === 'after' ? 'selected' : ''); ?>>After</option>
                  </select>
                </div>
                <div class="field">
                  <label><span class="material-icons-outlined">calendar_month</span> Days</label>
                  <input type="number" data-field="days" min="0" max="365" name="rules[<?php echo e($idx); ?>][days]" value="<?php echo e($rule['days']); ?>" required>
                </div>
                <div class="field">
                  <label><span class="material-icons-outlined">sync_alt</span> Offset Days</label>
                  <input type="number" data-field="offset_days" min="-365" max="365" name="rules[<?php echo e($idx); ?>][offset_days]" value="<?php echo e($rule['offset_days']); ?>" required>
          ...
          <div class="rem-grid">
            <div class="field">
              ...
              <select id="previewInvoiceNumber">
                ...
                <?php $__currentLoopData = $previewInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($invoice->invoice_number); ?>"><?php echo e($invoice->invoice_number); ?> - <?php echo e($invoice->bill_to_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            <div class="field">
              ...
              <select id="previewRuleId">
                ...
                <?php $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($rule['id']); ?>"><?php echo e($rule['name']); ?> (<?php echo e($rule['id']); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            <div class="field">
              ...
              <select id="previewTemplateId">
                ...
                <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($tpl->id); ?>"><?php echo e($tpl->template_name); ?> (#<?php echo e($tpl->id); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
  ...
  (function () {
    ...
    if (previewBtn) {
      previewBtn.addEventListener('click', async () => {
        ...
        try {
          const res = await fetch(<?php echo json_encode(route('settings.reminders.preview'), 15, 512) ?>, {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Invoice\Docubills web\Docubills\Docubills\resources\views/settings/reminders.blade.php ENDPATH**/ ?>