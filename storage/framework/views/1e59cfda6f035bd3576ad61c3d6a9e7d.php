...
<?php $__env->startSection('content'); ?>
  ...
  <form id="invoiceForm" method="POST" action="<?php echo e(route('invoices.import-source')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-section">
      ...
      <div class="form-grid">
        <div class="form-row position-relative">
          ...
          <input type="text" id="companyName" name="bill_to[Company Name]" class="form-control <?php $__errorArgs = ['bill_to.Company Name'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter company name" required autocomplete="off" value="<?php echo e(old('bill_to.Company Name')); ?>">
          <div id="clientSuggestions" class="autocomplete-list"></div>
          <?php $__errorArgs = ['bill_to.Company Name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-row">
          ...
          <input type="text" id="contactName" name="bill_to[Contact Name]" class="form-control <?php $__errorArgs = ['bill_to.Contact Name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Contact person's name" value="<?php echo e(old('bill_to.Contact Name')); ?>">
          <?php $__errorArgs = ['bill_to.Contact Name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-row">
          ...
          <input type="text" id="billAddress" name="bill_to[Address]" class="form-control <?php $__errorArgs = ['bill_to.Address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Full address" value="<?php echo e(old('bill_to.Address')); ?>">
          <?php $__errorArgs = ['bill_to.Address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-row">
          ...
          <input type="text" id="billPhone" name="bill_to[Phone]" class="form-control <?php $__errorArgs = ['bill_to.Phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Phone number" value="<?php echo e(old('bill_to.Phone')); ?>">
          <?php $__errorArgs = ['bill_to.Phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-row">
          ...
          <input type="email" id="billEmail" name="bill_to[Email]" class="form-control <?php $__errorArgs = ['bill_to.Email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Email address" required value="<?php echo e(old('bill_to.Email')); ?>">
          <?php $__errorArgs = ['bill_to.Email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
      ...
      <div class="form-row">
        ...
        <div class="source-picker" id="sourcePicker">
          <label class="source-option" data-source-card data-source="google">
            <input type="radio" name="invoice_source" value="google" <?php echo e(old('invoice_source', session('import_error') ? 'upload' : 'google') === 'google' ? 'checked' : ''); ?>>
            <span>
          ...
          <label class="source-option" data-source-card data-source="upload">
            <input type="radio" name="invoice_source" value="upload" <?php echo e(old('invoice_source', session('import_error') ? 'upload' : 'google') === 'upload' ? 'checked' : ''); ?>>
            <span>
        ...
        <?php $__errorArgs = ['invoice_source'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div id="google-section" class="source-panel">
        <div class="form-row">
          ...
          <input type="url" id="google_sheet_url" name="google_sheet_url" class="form-control <?php $__errorArgs = ['google_sheet_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="https://docs.google.com/spreadsheets/..." value="<?php echo e(old('google_sheet_url')); ?>">
      ...
      <div id="upload-section" class="source-panel is-hidden">
        ...
        <div class="form-row">
          ...
          <div class="upload-container" id="uploadArea">
            ...
            <input type="file" id="excel_file" name="file" accept="<?php echo e($zipAvailable ? '.xls,.xlsx,.csv' : '.csv'); ?>" class="is-hidden">
          </div>
...
<script>
  ...
  const zipAvailable = <?php echo json_encode($zipAvailable, 15, 512) ?>;
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    companyInput.addEventListener('input', function () {
      ...
      fetch('<?php echo e(route("api.clients.search")); ?>?q=' + encodeURIComponent(q))
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Invoice\Docubills web\Docubills\Docubills\resources\views/invoices/create.blade.php ENDPATH**/ ?>