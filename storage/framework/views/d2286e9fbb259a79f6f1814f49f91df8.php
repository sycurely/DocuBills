...
<div class="header">
  <a href="<?php echo e(route('dashboard')); ?>" class="logo">
    <?php if(!empty($appLogoSrc)): ?>
      <img src="<?php echo e($appLogoSrc); ?>" alt="<?php echo e($appName); ?>" width="208" height="56" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline';">
      <span class="logo-text-fallback is-hidden"><?php echo e($appName); ?></span>
    <?php else: ?>
  ...
  <div class="header-actions">
    ...
    <div class="user-profile" id="userProfileTrigger">
      <div class="user-avatar">
        <img src="<?php echo e($avatarPath); ?>?v=<?php echo e(time()); ?>" alt="Avatar" onerror="this.onerror=null; this.src='<?php echo e($defaultAvatarUrl); ?>';">
        <span class="is-hidden"><?php echo e($initials); ?></span>
      </div>
      <span class="user-name"><?php echo e($userName); ?></span>
      <div class="profile-menu" id="profileMenu">
        <a href="<?php echo e(route('users.show', $user)); ?>"><span class="material-icons-outlined">person</span> My Profile</a>
...
document.getElementById('headerPasswordForm')?.addEventListener('submit', function(e) {
  ...
  fetch('<?php echo e(route("api.users.update-password")); ?>', {
    method: 'POST',
    headers: {
...
<?php /**PATH D:\Invoice\Docubills web\Docubills\Docubills\resources\views/partials/header.blade.php ENDPATH**/ ?>