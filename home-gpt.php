...
<head>
  ...
  <style>
    ...
    .glass{
      /* ...your existing background/border/backdrop-filter... */
      color: rgba(var(--text), 0.96); /* ✅ ensures text is always visible on dark glass */
    }
    ...
    /* Dot becomes bigger only in the drawer pill */
    .demo-live-pill-lg .dot{
      width:9px;
      height:9px;
    }
...
<body class="bg-slate-950 text-slate-100">
  ...
  <div class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative">
      <!-- Header / Nav -->
      <header class="mx-auto max-w-screen-2xl px-4 sm:px-8 lg:px-12 pt-6 sticky-nav">
        <div class="glass shadow-soft rounded-2xl px-4 sm:px-6 py-4 flex items-center justify-between">
          <a href="#" class="flex items-center gap-3">
            ...
            <div class="leading-tight">
              ...
              <div class="text-slate-300 text-xs">Free custom invoice generator</div>
            </div>
          </a>
        ...
        <div class="grid lg:grid-cols-2 gap-10 items-center">
          <!-- Left -->
            ...
            <h1 class="mt-5 text-white text-4xl sm:text-5xl font-extrabold leading-tight">
              Turn your spreadsheet into a <span class="gradient-text">professional invoice</span> — in 3 steps.
            </h1>
            
            <p class="mt-5 text-slate-200 text-lg leading-relaxed">
              Upload Excel or paste a Google Sheet URL. Choose <span class="text-white font-semibold">any column as Price</span>.
              Then toggle off unwanted rows/columns before exporting a clean PDF invoice.
              Add recurring invoices, banking details, currency symbols, Stripe “Pay Now”, and automated reminders when you’re ready.
            </p>
            ...
            <div class="mt-6 flex flex-col sm:flex-row gap-3">
              <a id="ctaBtnHero" href="register.php"
      ...
      <!-- Features -->
      <section id="features" class="mx-auto max-w-screen-2xl px-4 sm:px-8 lg:px-12 pb-20">
        <div class="glass rounded-3xl p-6 sm:p-8 shadow-soft text-center">
          <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-600/50 bg-white/5 text-slate-200 text-sm">
            <i class="fa-solid fa-sparkles text-cyan-300"></i>
            <span class="font-semibold tracking-wide">Features</span>
          </div>
        
          <div class="mt-4 text-white font-extrabold text-3xl sm:text-4xl">
            Built for real workflows
          </div>
        
          <div class="text-slate-300 mt-3 max-w-2xl mx-auto">
            Generate invoices from the data you already track — without reformatting your spreadsheet or starting over.
          </div>
        </div>

        <div class="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          <!-- Feature cards with placeholder SVG icons -->
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="flex items-center gap-3">
              <div class="h-11 w-11 rounded-2xl bg-violet-500/10 border border-violet-400/30 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" class="opacity-90">
                  <path d="M4 7h16M4 12h10M4 17h16" stroke="rgb(147,197,253)" stroke-width="2" stroke-linecap="round"/>
                </svg>
              </div>
              <div class="text-white font-semibold">Upload Excel / Link Sheets</div>
            </div>
            <div class="text-slate-300 text-sm mt-3">
              Keep your spreadsheet workflow. DocuBills reads your columns and builds invoices instantly.
            </div>
          </div>
          ...
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="flex items-center gap-3">
              <div class="h-11 w-11 rounded-2xl bg-violet-500/10 border border-violet-400/30 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" class="opacity-90">
                  <path d="M12 3v18M3 12h18" stroke="rgb(147,197,253)" stroke-width="2" stroke-linecap="round"/>
                  <path d="M7 7l10 10" stroke="rgb(147,197,253)" stroke-width="2" stroke-linecap="round"/>
                </svg>
              </div>
              <div class="text-white font-semibold">Map any Price column</div>
            </div>
            <div class="text-slate-300 text-sm mt-3">
              Use <span class="text-white font-semibold">Rate</span>, <span class="text-white font-semibold">Cost</span>, or a custom column like “Dispatcher Price”.
            </div>
          </div>
          ...
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="flex items-center gap-3">
              <div class="h-11 w-11 rounded-2xl bg-violet-500/10 border border-violet-400/30 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" class="opacity-90">
                  <path d="M7 8h10M7 12h10M7 16h6" stroke="rgb(147,197,253)" stroke-width="2" stroke-linecap="round"/>
                  <path d="M5 4h14v16H5z" stroke="rgb(147,197,253)" stroke-width="2" />
                </svg>
              </div>
              <div class="text-white font-semibold">Toggle rows & columns</div>
            </div>
            <div class="text-slate-300 text-sm mt-3">
              Hide notes, exclude internal columns, or remove rows — without changing your sheet.
            </div>
          </div>
          ...
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="flex items-center gap-3">
              <div class="h-11 w-11 rounded-2xl bg-violet-500/10 border border-violet-400/30 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" class="opacity-90">
                  <path d="M4 12a8 8 0 1 0 16 0" stroke="rgb(147,197,253)" stroke-width="2" stroke-linecap="round"/>
                  <path d="M12 6v6l4 2" stroke="rgb(147,197,253)" stroke-width="2" stroke-linecap="round"/>
                </svg>
              </div>
              <div class="text-white font-semibold">Email cadences</div>
            </div>
            <div class="text-slate-300 text-sm mt-3">
              Auto-reminders: before due date, on due date, and overdue sequences — hands-free.
            </div>
          </div>
          ...
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="flex items-center gap-3">
              <div class="h-11 w-11 rounded-2xl bg-violet-500/10 border border-violet-400/30 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" class="opacity-90">
                  <path d="M7 10h10M7 14h10" stroke="rgb(147,197,253)" stroke-width="2" stroke-linecap="round"/>
                  <path d="M6 6h12v12H6z" stroke="rgb(147,197,253)" stroke-width="2" />
                </svg>
              </div>
              <div class="text-white font-semibold">Recurring invoices</div>
            </div>
            <div class="text-slate-300 text-sm mt-3">
              Monthly, weekly, custom schedules — generate and send automatically.
            </div>
          </div>
          ...
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="flex items-center gap-3">
              <div class="h-11 w-11 rounded-2xl bg-violet-500/10 border border-violet-400/30 flex items-center justify-center">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" class="opacity-90">
                  <path d="M12 3l9 6-9 6-9-6 9-6z" stroke="rgb(147,197,253)" stroke-width="2" />
                  <path d="M3 9v6l9 6 9-6V9" stroke="rgb(147,197,253)" stroke-width="2" />
                </svg>
              </div>
              <div class="text-white font-semibold">Stripe payments</div>
            </div>
            <div class="text-slate-300 text-sm mt-3">
              Add “Pay Now” links, track status, and reduce payment delays with checkout.
            </div>
          </div>
        </div>

        <!-- CTA strip -->
        <div class="mt-10 glass rounded-3xl p-6 sm:p-8 shadow-soft flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <div class="text-white font-extrabold text-2xl">Ready to invoice from your sheet?</div>
            <div class="text-slate-300 mt-2">Start free. Build your first invoice in minutes.</div>
          </div>
          <div class="flex gap-2">
            <a id="loginBtnMid" href="login.php"
               class="px-4 py-2 rounded-2xl border border-slate-600/60 text-slate-100 hover:text-white hover:border-slate-400 transition">
              Login
            </a>
            <a id="ctaBtnMid" href="register.php"
      ...
      <section id="faq" class="mx-auto max-w-screen-2xl px-4 sm:px-8 lg:px-12 pb-20">
        <div class="glass rounded-3xl p-6 sm:p-8 shadow-soft text-center">
          <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-600/50 bg-white/5 text-slate-200 text-sm">
            ...
            <span class="font-semibold tracking-wide">FAQ</span>
          </div>
        ...
        <div class="mt-8 grid lg:grid-cols-2 gap-4">
          <div class="glass rounded-3xl p-6 shadow-soft">
            ...
            <div class="text-slate-300 text-sm mt-2">
              Yes. Generate invoices for free. If you enable Stripe payments or premium automations later, that’s optional.
            </div>
          </div>
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="text-white font-semibold">What makes it different from other generators?</div>
            <div class="text-slate-300 text-sm mt-2">
              You can upload Excel/Sheets and choose any column as Price. You’re not forced into a fixed template.
            </div>
          </div>
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="text-white font-semibold">Can I hide columns/rows before sending?</div>
            <div class="text-slate-300 text-sm mt-2">
              Yes — toggle rows/columns without changing your source spreadsheet.
            </div>
          </div>
          <div class="glass rounded-3xl p-6 shadow-soft">
            <div class="text-white font-semibold">Can I automate reminders and recurring invoices?</div>
            <div class="text-slate-300 text-sm mt-2">
              Yes — email cadences, recurring schedules, and payment links are built into the workflow.
            </div>
          </div>
        </div>
      </section>
  ...
  <script>
    ...
    document.getElementById("loginBtnTop").href = LOGIN_URL;
    document.getElementById("loginBtnMid").href = LOGIN_URL;
    document.getElementById("modalLogin").href = LOGIN_URL;

    document.getElementById("ctaBtnTop").href = GET_STARTED_URL;
    document.getElementById("ctaBtnHero").href = GET_STARTED_URL;
    document.getElementById("ctaBtnMid").href = GET_STARTED_URL;
    document.getElementById("ctaBtnDemoBottom").href = GET_STARTED_URL;
    document.getElementById("modalGetStarted").href = GET_STARTED_URL;
