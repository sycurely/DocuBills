...
<body class="bg-slate-950 text-slate-100">
  ...
  <div class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative">
      <!-- Header / Nav -->
      <header class="mx-auto max-w-screen-2xl px-4 sm:px-8 lg:px-12 pt-6">
        ...
        <div class="grid lg:grid-cols-2 gap-10 items-center">
          <!-- Left -->
            ...
            <h1 class="mt-5 text-white text-4xl sm:text-5xl font-extrabold leading-tight">
              Generated22 invoices from your <span class="text-cyan-300">Excel / Google Sheets</span> — in minutes.
            </h1>

            <p class="mt-5 text-slate-200 text-lg leading-relaxed">
              DocuBills isn’t a rigid invoice template.
              Bring your spreadsheet, <span class="text-white font-semibold">pick any column as “Price”</span>,
              hide columns/rows you don’t want, and send a clean invoice your clients understand — with optional Stripe + reminders.
            </p>
